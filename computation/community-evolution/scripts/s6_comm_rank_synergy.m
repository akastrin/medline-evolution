...
function signifComms = s6_comm_rank_synergy(folder_name, top) %%Comment this line if you need the script
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
[siz,~]=size(commIds);
% commSize should be same width as commIds
% We add columns with zeros to the end
commSize(siz,length(commIds)) = 0;
...
save([folder_name,'data/matlab/other', '/comm-evol.mat'],'commEvol');
save([folder_name,'data/matlab/other', '/comm-evol-size.mat'],'commEvolSize');
save([folder_name,'data/matlab/other', '/comm-evol-ones.mat'],'commEvolOnes');
save([folder_name,'data/matlab/other', '/comm-evol-centr.mat'],'commEvolCentr');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
save([folder_name,'data/matlab/other', '/signif-comms.mat'],'signifComms')
