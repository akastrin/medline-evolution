...
function signifComms_sblt = s6_comm_rank_stability(folder_name, top) %%Comment this line if you need the script
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
save([folder_name,'data/matlab/other', '/signif-comms-stability.mat'],'signifComms_sblt')
